          ...
          <div class="cnt-account">
            <ul class="list-unstyled">
              ...
              <li><a href="{{ route('login')}}"><i class="icon fa fa-user"></i>
                @if (session()->get('language') == 'arabic') الملف الشخصي @else User Profile @endif
                </a></li>
              @else
              <li><a href="{{ route('login')}}"><i class="icon fa fa-lock"></i>
                @if (session()->get('language') == 'arabic') سجل الدخول / انشاء حساب جديد @else Login / Register @endif
                </a></li>
              @endauth
            </ul>
          </div>
