						...
						<div class="product-info">
							...
							<div class="rating-reviews m-t-20">
								<div class="row">
									...
									<div class="col-sm-8">
										<div class="reviews">
											<a href="#" class="lnk">({{ count($reviewcount) }} Review)</a>
										</div>
									</div>
								</div><!-- /.row -->
							</div><!-- /.rating-reviews -->
							...
							<div class="tab-content">
								...
								<div id="description" class="tab-pane in active">
									<div class="product-tab">
										<p class="text">
                                            @if (session()->get('language') == 'arabic') {!! $product->long_descp_ar!!} @else {!! $product->long_descp_en!!} @endif
                                        </p>
									</div>
								</div><!-- /.tab-pane -->
								...
								<div id="review" class="tab-pane">
									<div class="product-tab">
										...
										<div class="product-reviews">
                                            ...
                                            @php
                                                $reviews = App\Models\Review::with('user')->where('product_id',$product->id)->latest()->limit(5)->get();
                                            @endphp
                                            ...
                                            <div class="reviews">
                                                ...
                                                @foreach ($reviews as $item)
                                                    ...
                                                    @else
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <img class="card-img-top" style="border-radius: 50%" height="40px;" width="40px;" src="{{ (!empty($item->user->profile_photo_path))? url('upload/user_images/'.$item->user->profile_photo_path) : url('upload/no_image.jpg') }}">
                                                                <b>{{ $item->user->name}}</b>
                        ...
                        <div class="item item-carousel">
                            ...
                            <div class="product">
                                <div class="product-image">
                                    <div class="image">
                                        <a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en) }}"><img  src="{{ asset($item->product_thambnail)}}" alt=""></a>
                                    </div><!-- /.image -->
                                ...
                                <div class="product-info text-left">
                                    ...
                                    @else
                                    <div class="product-price"><span class="price">${{$product->discount_price}}</span><span class="price-before-discount">${{$product->selling_price}}</span></div><!-- /.product-price -->
                                    @endif
