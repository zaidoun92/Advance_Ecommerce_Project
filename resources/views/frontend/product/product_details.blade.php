                                            ...
                                            <div class="reviews">
                                                ...
                                                @foreach ($reviews as $item)
                                                    ...
                                                    @else
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <img class="card-img-top" style="border-radius: 50%" height="40px;" width="40px;" src="{{ (!empty($item->user->profile_photo_path))? url('upload/user_images/'.$item->user->profile_photo_path) : url('upload/no_image.jpg') }}"><b>{{ $item->user->name}}</b>
                                                            </div>
