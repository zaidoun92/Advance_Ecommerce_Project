                ...
                <div class="row"> <!-- start 7th row  -->
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <textarea name="short_descp_ar" id="textarea" class="form-control" required placeholder="Textarea text">{{ $products->short_descp_ar}}</textarea>
                            </div>
                        </div>
                    </div> <!-- end col md 6 -->
                </div> <!-- end 7th row  -->
                  ...
                  <form method="post" action="{{ route('update.product.image') }}" enctype="multipart/form-data">
                    ...
                    <div class="row row-sm">
                        @foreach ($multiImgs as $img)
                            <div class="col-md-3">
                                <div class="card">
                                    <img src="{{ asset($img->photo_name)}}" class="card-img-top" style="height: 130px; width: 130px;">
                                    <div class="card-body">
                                      <h5 class="card-title">
				...
				<div class="box bt-3 border-info">
                  ...
                  <form method="post" action="{{ route('update.product.thumbnail') }}" enctype="multipart/form-data">
                    ...
                    <div class="row row-sm">
                            <div class="col-md-3">
                                <div class="card">
                                    <img src="{{ asset($products->product_thambnail)}}" id="mainThmb" class="card-img-top" style="height: 130px; width: 130px;">
                                    <div class="card-body">
