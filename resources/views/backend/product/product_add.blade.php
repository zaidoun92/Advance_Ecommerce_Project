                        ...
                        <div class="row"> {{-- Start thered Row --}}
                            ...
                            <div class="col-md-4"> {{-- Start col --}}
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_tags_en" class="form-control" value="Lorem,Ipsum,Amet" data-role="tagsinput" placeholder="add tags" required="">
                                    </div>
                        ...
                        <div class="row"> {{-- Start Fourth Row --}}
                            <div class="col-md-4"> {{-- Start col --}}
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_tags_ar" class="form-control" value="Lorem,Ipsum,Amet" data-role="tagsinput" placeholder="add tags" required="">
                                    </div>
                            ...
                            <div class="col-md-4"> {{-- Start col --}}
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_size_en" class="form-control" value="Small,Midium,Large" data-role="tagsinput" placeholder="add tags" required="">
                                    </div>
                            ...
                            <div class="col-md-4"> {{-- Start col --}}
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_size_ar" class="form-control" value="Small,Midium,Large" data-role="tagsinput" placeholder="add tags" required="">
                                    </div>
                        ...
                        <div class="row"> {{-- Start Five Row --}}
                            <div class="col-md-4"> {{-- Start col --}}
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_color_en" class="form-control" value="red,black,green" data-role="tagsinput" placeholder="add tags" required="">
                                    </div>
                            ...
                            <div class="col-md-4"> {{-- Start col --}}
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_color_ar" class="form-control" value="red,black,green" data-role="tagsinput" placeholder="add tags" required="">
                                    </div>
                        ...
                        <div class="row"> {{-- Start Seven Row --}}
                            ...
                            <div class="col-md-6"> {{-- Start col --}}
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea id="editor2" name="long_descp_ar" rows="10" cols="80" required>Long Description Arabic.</textarea>
                                    </div>
                                </div>
                            </div> {{-- end col --}}
                        </div> {{-- end Sex Row --}}
    ...
    $(document).ready(function(){
        $('#multiImg').on('change', function() {
            ...
            if (window.File && window.FileReader && window.FileList && window.Blob) {
                ...
                var data = $(this)[0].files; // this is file data
